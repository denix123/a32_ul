...
Bool VG_(get_filename_linenum) ( Addr a, 
                                 HChar* filename, Int n_filename,
                                 HChar* dirname,  Int n_dirname,
                                  ...
                                  Bool*    isIFunc )
{
   ...
   if (sec_names) *sec_names = (HChar **)si->symtab[idx].sec_names; 
...
VgSectKind VG_(DebugInfo_sect_kind)( HChar* name, SizeT n_name, 
                                     Addr a)
{
   DebugInfo* di;
