...
struct DeleteBuffersImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei n) {
    return static_cast<uint32_t>(sizeof(GLuint) * n);  
  }
...
struct Uniform1fvImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLfloat) * 1 * count);  
  }
...
struct Uniform1ivImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLint) * 1 * count);  
  }
...
struct Uniform2fvImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLfloat) * 2 * count);  
  }
...
struct Uniform2ivImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLint) * 2 * count);  
  }
...
struct Uniform3fvImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLfloat) * 3 * count);  
  }
...
struct Uniform3ivImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLint) * 3 * count);  
  }
...
struct Uniform4fvImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLfloat) * 4 * count);  
  }
...
struct Uniform4ivImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLint) * 4 * count);  
  }
...
struct UniformMatrix3fvImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLfloat) * 9 * count);  
  }
...
struct UniformMatrix4fvImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLfloat) * 16 * count);  
  }
...
struct DiscardFramebufferEXTImmediate {
  ...
  static uint32_t ComputeDataSize(GLsizei count) {
    return static_cast<uint32_t>(sizeof(GLenum) * 1 * count);  
  }
