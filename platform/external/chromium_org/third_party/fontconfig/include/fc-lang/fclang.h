...
{
    { "aa",  { FC_REF_CONSTANT, 1, OFF(0,0), NUM(0,0) } }, 
    { "ab",  { FC_REF_CONSTANT, 1, OFF(1,1), NUM(1,1) } }, 
    { "af",  { FC_REF_CONSTANT, 2, OFF(2,2), NUM(2,2) } }, 
    { "ak",  { FC_REF_CONSTANT, 5, OFF(3,4), NUM(3,4) } }, 
    { "am",  { FC_REF_CONSTANT, 2, OFF(4,9), NUM(4,9) } }, 
    { "an",  { FC_REF_CONSTANT, 1, OFF(5,11), NUM(5,11) } }, 
    { "ar",  { FC_REF_CONSTANT, 1, OFF(6,12), NUM(6,12) } }, 
    { "as",  { FC_REF_CONSTANT, 1, OFF(7,13), NUM(7,13) } }, 
    { "ast",  { FC_REF_CONSTANT, 2, OFF(8,14), NUM(8,14) } }, 
    { "av",  { FC_REF_CONSTANT, 1, OFF(9,16), NUM(9,16) } }, 
    { "ay",  { FC_REF_CONSTANT, 1, OFF(10,17), NUM(10,17) } }, 
    { "az-az",  { FC_REF_CONSTANT, 3, OFF(11,18), NUM(11,18) } }, 
    { "az-ir",  { FC_REF_CONSTANT, 1, OFF(12,21), NUM(12,21) } }, 
    { "ba",  { FC_REF_CONSTANT, 1, OFF(13,22), NUM(13,22) } }, 
    { "be",  { FC_REF_CONSTANT, 1, OFF(14,23), NUM(14,23) } }, 
    { "ber-dz",  { FC_REF_CONSTANT, 4, OFF(15,24), NUM(15,24) } }, 
    { "ber-ma",  { FC_REF_CONSTANT, 1, OFF(16,28), NUM(16,28) } }, 
    { "bg",  { FC_REF_CONSTANT, 1, OFF(17,29), NUM(17,29) } }, 
    { "bh",  { FC_REF_CONSTANT, 1, OFF(18,30), NUM(18,30) } }, 
    { "bho",  { FC_REF_CONSTANT, 1, OFF(19,30), NUM(19,30) } }, 
    { "bi",  { FC_REF_CONSTANT, 1, OFF(20,31), NUM(20,31) } }, 
    { "bin",  { FC_REF_CONSTANT, 3, OFF(21,32), NUM(21,32) } }, 
    { "bm",  { FC_REF_CONSTANT, 3, OFF(22,35), NUM(22,35) } }, 
    { "bn",  { FC_REF_CONSTANT, 1, OFF(23,38), NUM(23,38) } }, 
    { "bo",  { FC_REF_CONSTANT, 1, OFF(24,39), NUM(24,39) } }, 
    { "br",  { FC_REF_CONSTANT, 1, OFF(25,40), NUM(25,40) } }, 
    { "brx",  { FC_REF_CONSTANT, 1, OFF(26,41), NUM(26,41) } }, 
    { "bs",  { FC_REF_CONSTANT, 2, OFF(27,42), NUM(27,42) } }, 
    { "bua",  { FC_REF_CONSTANT, 1, OFF(28,44), NUM(28,44) } }, 
    { "byn",  { FC_REF_CONSTANT, 2, OFF(29,45), NUM(29,45) } }, 
    { "ca",  { FC_REF_CONSTANT, 2, OFF(30,47), NUM(30,47) } }, 
    { "ce",  { FC_REF_CONSTANT, 1, OFF(31,16), NUM(31,16) } }, 
    { "ch",  { FC_REF_CONSTANT, 1, OFF(32,49), NUM(32,49) } }, 
    { "chm",  { FC_REF_CONSTANT, 1, OFF(33,50), NUM(33,50) } }, 
    { "chr",  { FC_REF_CONSTANT, 1, OFF(34,51), NUM(34,51) } }, 
    { "co",  { FC_REF_CONSTANT, 2, OFF(35,52), NUM(35,52) } }, 
    { "crh",  { FC_REF_CONSTANT, 2, OFF(36,54), NUM(36,54) } }, 
    { "cs",  { FC_REF_CONSTANT, 2, OFF(37,56), NUM(37,56) } }, 
    { "csb",  { FC_REF_CONSTANT, 2, OFF(38,58), NUM(38,58) } }, 
    { "cu",  { FC_REF_CONSTANT, 1, OFF(39,60), NUM(39,60) } }, 
    { "cv",  { FC_REF_CONSTANT, 2, OFF(40,61), NUM(40,61) } }, 
    { "cy",  { FC_REF_CONSTANT, 3, OFF(41,63), NUM(41,63) } }, 
    { "da",  { FC_REF_CONSTANT, 1, OFF(42,66), NUM(42,66) } }, 
    { "de",  { FC_REF_CONSTANT, 1, OFF(43,67), NUM(43,67) } }, 
    { "doi",  { FC_REF_CONSTANT, 1, OFF(44,68), NUM(44,68) } }, 
    { "dv",  { FC_REF_CONSTANT, 1, OFF(45,69), NUM(45,69) } }, 
    { "dz",  { FC_REF_CONSTANT, 1, OFF(46,39), NUM(46,39) } }, 
    { "ee",  { FC_REF_CONSTANT, 4, OFF(47,70), NUM(47,70) } }, 
    { "el",  { FC_REF_CONSTANT, 1, OFF(48,74), NUM(48,74) } }, 
    { "en",  { FC_REF_CONSTANT, 1, OFF(49,75), NUM(49,75) } }, 
    { "eo",  { FC_REF_CONSTANT, 2, OFF(50,76), NUM(50,76) } }, 
    { "es",  { FC_REF_CONSTANT, 1, OFF(51,11), NUM(51,11) } }, 
    { "et",  { FC_REF_CONSTANT, 2, OFF(52,78), NUM(52,78) } }, 
    { "eu",  { FC_REF_CONSTANT, 1, OFF(53,80), NUM(53,80) } }, 
    { "fa",  { FC_REF_CONSTANT, 1, OFF(54,21), NUM(54,21) } }, 
    { "fat",  { FC_REF_CONSTANT, 5, OFF(55,4), NUM(55,4) } }, 
    { "ff",  { FC_REF_CONSTANT, 3, OFF(56,81), NUM(56,81) } }, 
    { "fi",  { FC_REF_CONSTANT, 2, OFF(57,84), NUM(57,84) } }, 
    { "fil",  { FC_REF_CONSTANT, 1, OFF(58,86), NUM(58,86) } }, 
    { "fj",  { FC_REF_CONSTANT, 1, OFF(59,87), NUM(59,87) } }, 
    { "fo",  { FC_REF_CONSTANT, 1, OFF(60,88), NUM(60,88) } }, 
    { "fr",  { FC_REF_CONSTANT, 2, OFF(61,52), NUM(61,52) } }, 
    { "fur",  { FC_REF_CONSTANT, 1, OFF(62,89), NUM(62,89) } }, 
    { "fy",  { FC_REF_CONSTANT, 1, OFF(63,90), NUM(63,90) } }, 
    { "ga",  { FC_REF_CONSTANT, 3, OFF(64,91), NUM(64,91) } }, 
    { "gd",  { FC_REF_CONSTANT, 1, OFF(65,94), NUM(65,94) } }, 
    { "gez",  { FC_REF_CONSTANT, 2, OFF(66,95), NUM(66,95) } }, 
    { "gl",  { FC_REF_CONSTANT, 1, OFF(67,11), NUM(67,11) } }, 
    { "gn",  { FC_REF_CONSTANT, 3, OFF(68,97), NUM(68,97) } }, 
    { "gu",  { FC_REF_CONSTANT, 1, OFF(69,100), NUM(69,100) } }, 
    { "gv",  { FC_REF_CONSTANT, 1, OFF(70,101), NUM(70,101) } }, 
    { "ha",  { FC_REF_CONSTANT, 3, OFF(71,102), NUM(71,102) } }, 
    { "haw",  { FC_REF_CONSTANT, 3, OFF(72,105), NUM(72,105) } }, 
    { "he",  { FC_REF_CONSTANT, 1, OFF(73,108), NUM(73,108) } }, 
    { "hi",  { FC_REF_CONSTANT, 1, OFF(74,30), NUM(74,30) } }, 
    { "hne",  { FC_REF_CONSTANT, 1, OFF(75,30), NUM(75,30) } }, 
    { "ho",  { FC_REF_CONSTANT, 1, OFF(76,87), NUM(76,87) } }, 
    { "hr",  { FC_REF_CONSTANT, 2, OFF(77,42), NUM(77,42) } }, 
    { "hsb",  { FC_REF_CONSTANT, 2, OFF(78,109), NUM(78,109) } }, 
    { "ht",  { FC_REF_CONSTANT, 1, OFF(79,111), NUM(79,111) } }, 
    { "hu",  { FC_REF_CONSTANT, 2, OFF(80,112), NUM(80,112) } }, 
    { "hy",  { FC_REF_CONSTANT, 1, OFF(81,114), NUM(81,114) } }, 
    { "hz",  { FC_REF_CONSTANT, 3, OFF(82,115), NUM(82,115) } }, 
    { "ia",  { FC_REF_CONSTANT, 1, OFF(83,87), NUM(83,87) } }, 
    { "id",  { FC_REF_CONSTANT, 1, OFF(84,118), NUM(84,118) } }, 
    { "ie",  { FC_REF_CONSTANT, 1, OFF(85,87), NUM(85,87) } }, 
    { "ig",  { FC_REF_CONSTANT, 2, OFF(86,119), NUM(86,119) } }, 
    { "ii",  { FC_REF_CONSTANT, 5, OFF(87,121), NUM(87,121) } }, 
    { "ik",  { FC_REF_CONSTANT, 1, OFF(88,126), NUM(88,126) } }, 
    { "io",  { FC_REF_CONSTANT, 1, OFF(89,87), NUM(89,87) } }, 
    { "is",  { FC_REF_CONSTANT, 1, OFF(90,127), NUM(90,127) } }, 
    { "it",  { FC_REF_CONSTANT, 1, OFF(91,128), NUM(91,128) } }, 
    { "iu",  { FC_REF_CONSTANT, 3, OFF(92,129), NUM(92,129) } }, 
    { "ja",  { FC_REF_CONSTANT, 83, OFF(93,132), NUM(93,132) } }, 
    { "jv",  { FC_REF_CONSTANT, 1, OFF(94,215), NUM(94,215) } }, 
    { "ka",  { FC_REF_CONSTANT, 1, OFF(95,216), NUM(95,216) } }, 
    { "kaa",  { FC_REF_CONSTANT, 1, OFF(96,217), NUM(96,217) } }, 
    { "kab",  { FC_REF_CONSTANT, 4, OFF(97,24), NUM(97,24) } }, 
    { "ki",  { FC_REF_CONSTANT, 2, OFF(98,218), NUM(98,218) } }, 
    { "kj",  { FC_REF_CONSTANT, 1, OFF(99,87), NUM(99,87) } }, 
    { "kk",  { FC_REF_CONSTANT, 1, OFF(100,220), NUM(100,220) } }, 
    { "kl",  { FC_REF_CONSTANT, 2, OFF(101,221), NUM(101,221) } }, 
    { "km",  { FC_REF_CONSTANT, 1, OFF(102,223), NUM(102,223) } }, 
    { "kn",  { FC_REF_CONSTANT, 1, OFF(103,224), NUM(103,224) } }, 
    { "ko",  { FC_REF_CONSTANT, 45, OFF(104,225), NUM(104,225) } }, 
    { "kok",  { FC_REF_CONSTANT, 1, OFF(105,30), NUM(105,30) } }, 
    { "kr",  { FC_REF_CONSTANT, 3, OFF(106,270), NUM(106,270) } }, 
    { "ks",  { FC_REF_CONSTANT, 1, OFF(107,273), NUM(107,273) } }, 
    { "ku-am",  { FC_REF_CONSTANT, 2, OFF(108,274), NUM(108,274) } }, 
    { "ku-iq",  { FC_REF_CONSTANT, 1, OFF(109,276), NUM(109,276) } }, 
    { "ku-ir",  { FC_REF_CONSTANT, 1, OFF(110,276), NUM(110,276) } }, 
    { "ku-tr",  { FC_REF_CONSTANT, 2, OFF(111,277), NUM(111,277) } }, 
    { "kum",  { FC_REF_CONSTANT, 1, OFF(112,279), NUM(112,279) } }, 
    { "kv",  { FC_REF_CONSTANT, 1, OFF(113,280), NUM(113,280) } }, 
    { "kw",  { FC_REF_CONSTANT, 3, OFF(114,281), NUM(114,281) } }, 
    { "kwm",  { FC_REF_CONSTANT, 1, OFF(115,87), NUM(115,87) } }, 
    { "ky",  { FC_REF_CONSTANT, 1, OFF(116,284), NUM(116,284) } }, 
    { "la",  { FC_REF_CONSTANT, 2, OFF(117,285), NUM(117,285) } }, 
    { "lah",  { FC_REF_CONSTANT, 1, OFF(118,287), NUM(118,287) } }, 
    { "lb",  { FC_REF_CONSTANT, 1, OFF(119,288), NUM(119,288) } }, 
    { "lez",  { FC_REF_CONSTANT, 1, OFF(120,16), NUM(120,16) } }, 
    { "lg",  { FC_REF_CONSTANT, 2, OFF(121,289), NUM(121,289) } }, 
    { "li",  { FC_REF_CONSTANT, 1, OFF(122,291), NUM(122,291) } }, 
    { "ln",  { FC_REF_CONSTANT, 4, OFF(123,292), NUM(123,292) } }, 
    { "lo",  { FC_REF_CONSTANT, 1, OFF(124,296), NUM(124,296) } }, 
    { "lt",  { FC_REF_CONSTANT, 2, OFF(125,297), NUM(125,297) } }, 
    { "lv",  { FC_REF_CONSTANT, 2, OFF(126,299), NUM(126,299) } }, 
    { "mai",  { FC_REF_CONSTANT, 1, OFF(127,30), NUM(127,30) } }, 
    { "mg",  { FC_REF_CONSTANT, 1, OFF(128,301), NUM(128,301) } }, 
    { "mh",  { FC_REF_CONSTANT, 2, OFF(129,302), NUM(129,302) } }, 
    { "mi",  { FC_REF_CONSTANT, 3, OFF(130,304), NUM(130,304) } }, 
    { "mk",  { FC_REF_CONSTANT, 1, OFF(131,307), NUM(131,307) } }, 
    { "ml",  { FC_REF_CONSTANT, 1, OFF(132,308), NUM(132,308) } }, 
    { "mn-cn",  { FC_REF_CONSTANT, 1, OFF(133,309), NUM(133,309) } }, 
    { "mn-mn",  { FC_REF_CONSTANT, 1, OFF(134,310), NUM(134,310) } }, 
    { "mni",  { FC_REF_CONSTANT, 1, OFF(135,311), NUM(135,311) } }, 
    { "mo",  { FC_REF_CONSTANT, 4, OFF(136,312), NUM(136,312) } }, 
    { "mr",  { FC_REF_CONSTANT, 1, OFF(137,30), NUM(137,30) } }, 
    { "ms",  { FC_REF_CONSTANT, 1, OFF(138,87), NUM(138,87) } }, 
    { "mt",  { FC_REF_CONSTANT, 2, OFF(139,316), NUM(139,316) } }, 
    { "my",  { FC_REF_CONSTANT, 1, OFF(140,318), NUM(140,318) } }, 
    { "na",  { FC_REF_CONSTANT, 2, OFF(141,319), NUM(141,319) } }, 
    { "nb",  { FC_REF_CONSTANT, 1, OFF(142,321), NUM(142,321) } }, 
    { "nds",  { FC_REF_CONSTANT, 1, OFF(143,67), NUM(143,67) } }, 
    { "ne",  { FC_REF_CONSTANT, 1, OFF(144,322), NUM(144,322) } }, 
    { "ng",  { FC_REF_CONSTANT, 1, OFF(145,87), NUM(145,87) } }, 
    { "nl",  { FC_REF_CONSTANT, 1, OFF(146,323), NUM(146,323) } }, 
    { "nn",  { FC_REF_CONSTANT, 1, OFF(147,324), NUM(147,324) } }, 
    { "no",  { FC_REF_CONSTANT, 1, OFF(148,321), NUM(148,321) } }, 
    { "nqo",  { FC_REF_CONSTANT, 1, OFF(149,325), NUM(149,325) } }, 
    { "nr",  { FC_REF_CONSTANT, 1, OFF(150,87), NUM(150,87) } }, 
    { "nso",  { FC_REF_CONSTANT, 2, OFF(151,326), NUM(151,326) } }, 
    { "nv",  { FC_REF_CONSTANT, 4, OFF(152,328), NUM(152,328) } }, 
    { "ny",  { FC_REF_CONSTANT, 2, OFF(153,332), NUM(153,332) } }, 
    { "oc",  { FC_REF_CONSTANT, 1, OFF(154,334), NUM(154,334) } }, 
    { "om",  { FC_REF_CONSTANT, 1, OFF(155,87), NUM(155,87) } }, 
    { "or",  { FC_REF_CONSTANT, 1, OFF(156,335), NUM(156,335) } }, 
    { "os",  { FC_REF_CONSTANT, 1, OFF(157,279), NUM(157,279) } }, 
    { "ota",  { FC_REF_CONSTANT, 1, OFF(158,336), NUM(158,336) } }, 
    { "pa",  { FC_REF_CONSTANT, 1, OFF(159,337), NUM(159,337) } }, 
    { "pa-pk",  { FC_REF_CONSTANT, 1, OFF(160,287), NUM(160,287) } }, 
    { "pap-an",  { FC_REF_CONSTANT, 1, OFF(161,338), NUM(161,338) } }, 
    { "pap-aw",  { FC_REF_CONSTANT, 1, OFF(162,339), NUM(162,339) } }, 
    { "pl",  { FC_REF_CONSTANT, 2, OFF(163,340), NUM(163,340) } }, 
    { "ps-af",  { FC_REF_CONSTANT, 1, OFF(164,342), NUM(164,342) } }, 
    { "ps-pk",  { FC_REF_CONSTANT, 1, OFF(165,343), NUM(165,343) } }, 
    { "pt",  { FC_REF_CONSTANT, 1, OFF(166,344), NUM(166,344) } }, 
    { "qu",  { FC_REF_CONSTANT, 2, OFF(167,345), NUM(167,345) } }, 
    { "quz",  { FC_REF_CONSTANT, 2, OFF(168,345), NUM(168,345) } }, 
    { "rm",  { FC_REF_CONSTANT, 1, OFF(169,347), NUM(169,347) } }, 
    { "rn",  { FC_REF_CONSTANT, 1, OFF(170,87), NUM(170,87) } }, 
    { "ro",  { FC_REF_CONSTANT, 3, OFF(171,348), NUM(171,348) } }, 
    { "ru",  { FC_REF_CONSTANT, 1, OFF(172,279), NUM(172,279) } }, 
    { "rw",  { FC_REF_CONSTANT, 1, OFF(173,87), NUM(173,87) } }, 
    { "sa",  { FC_REF_CONSTANT, 1, OFF(174,30), NUM(174,30) } }, 
    { "sah",  { FC_REF_CONSTANT, 1, OFF(175,351), NUM(175,351) } }, 
    { "sat",  { FC_REF_CONSTANT, 1, OFF(176,352), NUM(176,352) } }, 
    { "sc",  { FC_REF_CONSTANT, 1, OFF(177,353), NUM(177,353) } }, 
    { "sco",  { FC_REF_CONSTANT, 3, OFF(178,354), NUM(178,354) } }, 
    { "sd",  { FC_REF_CONSTANT, 1, OFF(179,357), NUM(179,357) } }, 
    { "se",  { FC_REF_CONSTANT, 2, OFF(180,358), NUM(180,358) } }, 
    { "sel",  { FC_REF_CONSTANT, 1, OFF(181,279), NUM(181,279) } }, 
    { "sg",  { FC_REF_CONSTANT, 1, OFF(182,360), NUM(182,360) } }, 
    { "sh",  { FC_REF_CONSTANT, 3, OFF(183,361), NUM(183,361) } }, 
    { "shs",  { FC_REF_CONSTANT, 2, OFF(184,364), NUM(184,364) } }, 
    { "si",  { FC_REF_CONSTANT, 1, OFF(185,366), NUM(185,366) } }, 
    { "sid",  { FC_REF_CONSTANT, 2, OFF(186,367), NUM(186,367) } }, 
    { "sk",  { FC_REF_CONSTANT, 2, OFF(187,369), NUM(187,369) } }, 
    { "sl",  { FC_REF_CONSTANT, 2, OFF(188,42), NUM(188,42) } }, 
    { "sm",  { FC_REF_CONSTANT, 2, OFF(189,371), NUM(189,371) } }, 
    { "sma",  { FC_REF_CONSTANT, 1, OFF(190,373), NUM(190,373) } }, 
    { "smj",  { FC_REF_CONSTANT, 1, OFF(191,374), NUM(191,374) } }, 
    { "smn",  { FC_REF_CONSTANT, 2, OFF(192,375), NUM(192,375) } }, 
    { "sms",  { FC_REF_CONSTANT, 3, OFF(193,377), NUM(193,377) } }, 
    { "sn",  { FC_REF_CONSTANT, 1, OFF(194,87), NUM(194,87) } }, 
    { "so",  { FC_REF_CONSTANT, 1, OFF(195,87), NUM(195,87) } }, 
    { "sq",  { FC_REF_CONSTANT, 1, OFF(196,380), NUM(196,380) } }, 
    { "sr",  { FC_REF_CONSTANT, 1, OFF(197,381), NUM(197,381) } }, 
    { "ss",  { FC_REF_CONSTANT, 1, OFF(198,87), NUM(198,87) } }, 
    { "st",  { FC_REF_CONSTANT, 1, OFF(199,87), NUM(199,87) } }, 
    { "su",  { FC_REF_CONSTANT, 1, OFF(200,118), NUM(200,118) } }, 
    { "sv",  { FC_REF_CONSTANT, 1, OFF(201,382), NUM(201,382) } }, 
    { "sw",  { FC_REF_CONSTANT, 1, OFF(202,87), NUM(202,87) } }, 
    { "syr",  { FC_REF_CONSTANT, 1, OFF(203,383), NUM(203,383) } }, 
    { "ta",  { FC_REF_CONSTANT, 1, OFF(204,384), NUM(204,384) } }, 
    { "te",  { FC_REF_CONSTANT, 1, OFF(205,385), NUM(205,385) } }, 
    { "tg",  { FC_REF_CONSTANT, 1, OFF(206,386), NUM(206,386) } }, 
    { "th",  { FC_REF_CONSTANT, 1, OFF(207,387), NUM(207,387) } }, 
    { "ti-er",  { FC_REF_CONSTANT, 2, OFF(208,45), NUM(208,45) } }, 
    { "ti-et",  { FC_REF_CONSTANT, 2, OFF(209,367), NUM(209,367) } }, 
    { "tig",  { FC_REF_CONSTANT, 2, OFF(210,388), NUM(210,388) } }, 
    { "tk",  { FC_REF_CONSTANT, 2, OFF(211,390), NUM(211,390) } }, 
    { "tl",  { FC_REF_CONSTANT, 1, OFF(212,86), NUM(212,86) } }, 
    { "tn",  { FC_REF_CONSTANT, 2, OFF(213,326), NUM(213,326) } }, 
    { "to",  { FC_REF_CONSTANT, 2, OFF(214,371), NUM(214,371) } }, 
    { "tr",  { FC_REF_CONSTANT, 2, OFF(215,392), NUM(215,392) } }, 
    { "ts",  { FC_REF_CONSTANT, 1, OFF(216,87), NUM(216,87) } }, 
    { "tt",  { FC_REF_CONSTANT, 1, OFF(217,394), NUM(217,394) } }, 
    { "tw",  { FC_REF_CONSTANT, 5, OFF(218,4), NUM(218,4) } }, 
    { "ty",  { FC_REF_CONSTANT, 3, OFF(219,395), NUM(219,395) } }, 
    { "tyv",  { FC_REF_CONSTANT, 1, OFF(220,284), NUM(220,284) } }, 
    { "ug",  { FC_REF_CONSTANT, 1, OFF(221,398), NUM(221,398) } }, 
    { "uk",  { FC_REF_CONSTANT, 1, OFF(222,399), NUM(222,399) } }, 
    { "ur",  { FC_REF_CONSTANT, 1, OFF(223,287), NUM(223,287) } }, 
    { "uz",  { FC_REF_CONSTANT, 1, OFF(224,87), NUM(224,87) } }, 
    { "ve",  { FC_REF_CONSTANT, 2, OFF(225,400), NUM(225,400) } }, 
    { "vi",  { FC_REF_CONSTANT, 4, OFF(226,402), NUM(226,402) } }, 
    { "vo",  { FC_REF_CONSTANT, 1, OFF(227,406), NUM(227,406) } }, 
    { "vot",  { FC_REF_CONSTANT, 2, OFF(228,407), NUM(228,407) } }, 
    { "wa",  { FC_REF_CONSTANT, 1, OFF(229,409), NUM(229,409) } }, 
    { "wal",  { FC_REF_CONSTANT, 2, OFF(230,367), NUM(230,367) } }, 
    { "wen",  { FC_REF_CONSTANT, 2, OFF(231,410), NUM(231,410) } }, 
    { "wo",  { FC_REF_CONSTANT, 2, OFF(232,412), NUM(232,412) } }, 
    { "xh",  { FC_REF_CONSTANT, 1, OFF(233,87), NUM(233,87) } }, 
    { "yap",  { FC_REF_CONSTANT, 1, OFF(234,414), NUM(234,414) } }, 
    { "yi",  { FC_REF_CONSTANT, 1, OFF(235,108), NUM(235,108) } }, 
    { "yo",  { FC_REF_CONSTANT, 4, OFF(236,415), NUM(236,415) } }, 
    { "za",  { FC_REF_CONSTANT, 1, OFF(237,87), NUM(237,87) } }, 
    { "zh-cn",  { FC_REF_CONSTANT, 82, OFF(238,419), NUM(238,419) } }, 
    { "zh-hk",  { FC_REF_CONSTANT, 83, OFF(239,501), NUM(239,501) } }, 
    { "zh-mo",  { FC_REF_CONSTANT, 83, OFF(240,501), NUM(240,501) } }, 
    { "zh-sg",  { FC_REF_CONSTANT, 82, OFF(241,419), NUM(241,419) } }, 
    { "zh-tw",  { FC_REF_CONSTANT, 83, OFF(242,584), NUM(242,584) } }, 
    { "zu",  { FC_REF_CONSTANT, 1, OFF(243,87), NUM(243,87) } }, 
},
{
    { { 
...
static const FcChar32 fcLangCountrySets[][NUM_LANG_SET_MAP] = {
    ...
    { 0x00000000, 0x00000000, 0x00c00000, 0x00000000, 0x00000000, 0x00000000, 0x000c0000, 0x00000000, }, 
    { 0x00000000, 0x00000000, 0x00000000, 0x00000100, 0x00000000, 0x00000000, 0x01000000, 0x00000000, }, 
    { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x40000000, 0x00000000, }, 
    { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x80000000, 0x00000001, }, 
    { 0x00000000, 0x00000000, 0x00000000, 0x30000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, }, 
    { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x60000000, 0x00000000, 0x00000000, 0x00000000, }, 
    { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x1f000000, 0x00000000, 0x00000000, }, 
};
